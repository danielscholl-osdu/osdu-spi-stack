    ...
    "assets": [
        {
            ...
            "browser_download_url": "https://github.com/danielscholl-osdu/osdu-spi-stack/releases/download/v0.2.1/spi-0.2.1-py3-none-any.whl",
        },
        {
            "name": "spi-0.2.1.tar.gz",
            "browser_download_url": "https://github.com/danielscholl-osdu/osdu-spi-stack/releases/download/v0.2.1/spi-0.2.1.tar.gz",
        },
    ],
}
